...
export const HelpBox: React.FC = () => {
  ...
  const customerRoles: string[] = ['Ride Booker'];
  const tenantRoles: string[] = ['Business Owner', 'Employee User', 'Payment Manager', 'GPS Tracker Manager'];
  const addOns: string[] = ['chat', 'notifications'];
  const applicationName = `Carpool Maps Test`;
