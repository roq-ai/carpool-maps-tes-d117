...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'employee-user', 'payment-manager', 'gps-tracker-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    {
      name: 'Gps Tracker Manager',
      path: '/gps-tracker-managers',
